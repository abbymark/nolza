...
<script type="text/javascript">
    function shareKakaotalk() {
        ...
        Kakao.Link.sendDefault({
              objectType:"feed"
            , content : {
                  title:"아우어베이커리 가로수길점"   // 콘텐츠의 타이틀
                , description:"존맛탱 빵집 아우어베이커리 가로수길점"   // 콘텐츠 상세설명
                , imageUrl:"resources/imgs/bread.PNG"   // 썸네일 이미지
                , link : {
...
<body>
	...
	// 키워드로 장소를 검색합니다
	//ps.keywordSearch('아우어베이커리 가로수길점', placesSearchCB); 
	ps.keywordSearch('서울특별시 강남구 신사동 강남대로162길 39', placesSearchCB);
