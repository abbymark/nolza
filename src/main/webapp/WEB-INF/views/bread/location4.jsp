...
<script type="text/javascript">
    function shareKakaotalk() {
        ...
        Kakao.Link.sendDefault({
              objectType:"feed"
            , content : {
                  title:"타르틴베이커리 도산점"   // 콘텐츠의 타이틀
                , description:"존맛탱 빵집 타르틴베이커리 도산점"   // 콘텐츠 상세설명
...
<body>
	...
	// 키워드로 장소를 검색합니다
	//ps.keywordSearch('타르틴베이커리 도산점', placesSearchCB); 
	ps.keywordSearch('서울특별시 강남구 압구정동 언주로168길 24', placesSearchCB);
