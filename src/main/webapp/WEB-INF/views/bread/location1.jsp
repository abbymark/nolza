...
<script type="text/javascript">
    function shareKakaotalk() {
        ...
        Kakao.Link.sendDefault({
              objectType:"feed"
            , content : {
                  title:"어글리베이커리"   // 콘텐츠의 타이틀
                , description:"존맛탱 빵집 어글리베이커리"   // 콘텐츠 상세설명
                , imageUrl:"https://image.chosun.com/sitedata/image/201904/16/2019041602261_0.jpg"   // 썸네일 이미지
                , link : {
...
<body>
	...
	// 키워드로 장소를 검색합니다
	//ps.keywordSearch('어글리베이커리', placesSearchCB); 
	
	ps.keywordSearch('서울특별시 마포구 망원1동 월드컵로13길 73', placesSearchCB);
