			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card-body">
					<form class="form-signin" method="post" name="noticeUpdateForm" action="noticeUpdatePro.do?pageNum=${pageNum}" onsubmit="return check()">						
						...
						<div class="form-label-group">
							<label>글제목</label> 
							<input type="text" class="form-control" name="n_title" size="30" value="${dto.n_title}">
						</div>
						<hr>

						<div class="form-label-group">
							<label>글내용</label>
							<textarea name="n_content" class="form-control" rows="10" cols="60">${dto.n_content}</textarea>
						</div>
						<hr>
