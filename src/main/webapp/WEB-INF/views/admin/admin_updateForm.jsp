...
<script>
	function button_delete(){
		if( confirm("정말로 삭제하시겠습니까??")== true ){
			document.location.href='admin_deletePro?mem_id=${dto.mem_id}';	
		}else{ //취소
			return;
		}
	}
...
<form method="post" name="admin_updateForm" action="admin_updatePro" onsubmit="return check()" >
	<div class="form-group">
		...
		<div class="controls">
			<input type="text" id="mem_id" name="mem_id" class="floatLabel" value="${dto.mem_id}" readonly=TRUE>
			<label for="name">아이디</label>
		</div>

		<div class="controls">
			<input type="text" id="mem_nick" name="mem_nick" class="floatLabel" value="${dto.mem_nick}">
			<label for="email">닉네임</label>
		</div>
		<div class="controls">
			<input type="text" id="mem_pw" name="mem_pw" class="floatLabel" value="${dto.mem_pw}">
			<label for="phone">비밀번호</label>
		</div>
		
		<div class="controls">
			<input type="text" id="mem_email" name="mem_email" class="floatLabel" value="${dto.mem_email}">
		...
		<div class="grid">			
			<div class="controls">
				...
				<select class="floatLabel" name="mem_grade">
					<option value="${dto.mem_grade}">${dto.mem_grade}</option>
		...
		<div>
		<button type="submit" value=글수정 class="col-1-4">글수정</button>
		<button type="reset" value="다시작성" class="col-1-4" style="margin-left: 20px;">다시작성</button>
		<input type="button" value="글목록" class="col-1-4 btn_submit" style="margin-left: 20px;"
			onclick="location.href='admin_list'">
		<input type="button" value="삭제" class="col-1-4 btn_submit" style="margin-left: 20px;"
