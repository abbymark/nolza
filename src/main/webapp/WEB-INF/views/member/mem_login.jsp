...
<c:set var="mem_nick" value="${memberDto.mem_nick}" scope="session"/>
<c:set var="mem_grade" value="${memberDto.mem_grade}" scope="session"/>

<form method="post" name="admin_updateForm" action="mem_loginPro.do" onsubmit="return check()">
	<div class="form-group">
		<h2 class="heading">로그인</h2>

		<div class="controls">
			<input type="text" id="mem_id" name="mem_id" class="floatLabel">
		...
		<div>
			<button type="submit" value="로그인" class="col-1-4">로그인</button>
			<button type="reset" value="회원가입" class="col-1-4" style="margin-left: 20px;"
				onclick="document.location.href='mem_insertForm.do'"
			>회원가입</button>
		</div>
	</div>
