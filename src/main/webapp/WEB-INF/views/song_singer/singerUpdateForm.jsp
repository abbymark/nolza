	...
	<div class="container">
		<div class="row">
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card-body">
					<form class="form-signin" method="post" name="singerUpdateForm" action="singerUpdatePro.do" enctype="multipart/form-data">
						...
						<div class="form-label-group">
							<label>아티스트</label>
							<input type="text" class="form-control" name="ss_artist" size="30" value="${dto.ss_artist}">
						</div>
						<hr>
						...
						<div class="form-label-group">
							<label>활동유형</label>
							<input type="text" class="form-control" name="ss_style" size="30" value="${dto.ss_style}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>데뷔</label>
							<input type="date" class="form-control" name="ss_date" size="30" value="${dto.ss_date}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>데뷔곡</label>
							<input type="text" class="form-control" name="ss_title" size="30" value="${dto.ss_title}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>국적</label>
							<input type="text" class="form-control" name="ss_nation" size="30" value="${dto.ss_nation}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>멤버</label>
							<input type="text" class="form-control" name="ss_person" size="30" value="${dto.ss_person}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>소속사</label>
							<input type="text" class="form-control" name="ss_manage" size="30" value="${dto.ss_manage}">
						</div>
						<hr>
						
						<div class="form-label-group">
							<label>아티스트 소개</label>
							<textarea name="ss_content" class="form-control" rows="10" cols="60">${dto.ss_content}</textarea>
						</div>
						<hr>
